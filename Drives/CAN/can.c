...
#define CAN_FILTER_ID       (CAN_CHARGE_ROBOT_MAC_ID << 13)
...
void can_init(void)
{
    ...
    can_filter_init_struct.CAN_FilterMaskIdHigh    = (CAN_FILTER_MASK << 3) >> 16;
    can_filter_init_struct.CAN_FilterMaskIdLow     = ((CAN_FILTER_MASK << 3) & 0xffff) | 0x06;
...
void USB_LP_CAN1_RX0_IRQHandler(void)
{
    ...
    can_fifo_put_pkg(can_fifo,can_pkg_tmp);
}
